...
class BloomFilter {
    ...
    public boolean contains(String s) {
        ...
        for (int n = 0; n < noHashes; n++) {
            // Not 100% sure how this works, but its our hashcode
            long hc = hashCode(s, n);
            int bitNo = (int) (hc) & this.hashMask;

            // If this bit is false then we know it does not exist
            if (!data.get(bitNo)) {
                return false;
            }
        }
    ...
    public static final String LETTERS = "abcdefghijklmnopqrstuvexyABCDEFGHIJKLMNOPQRSTUVWYXZzéèêàôû";
