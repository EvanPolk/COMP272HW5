...
public class CuckooHash<K, V> {
     ...
     * that it is possible when the bucket lists is small, that we may need to
     * rehash
     ...
     * (and edge being defined as with end-points of the two bucket locations for
     * the
     * moved element). This once a cycle is detected in this graph, which is by
     * starting
     * to traverse an existing edge in the graph, we have a cycle. However, we have
     * not
